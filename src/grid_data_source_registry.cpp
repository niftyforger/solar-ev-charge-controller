...
const GridDataSource *const GRID_SOURCE_REGISTRY[] = {
    ...
    &GRID_SOURCE_SIMULATED_REACTIVE_NO_SUN,
    &GRID_SOURCE_SIMULATED_REACTIVE_LOW,
    &GRID_SOURCE_SIMULATED_REACTIVE_MODERATE,
    &GRID_SOURCE_SIMULATED_REACTIVE_HIGH,
    &GRID_SOURCE_SIMULATED_REACTIVE_BATTERY_DISCHARGE,
    &GRID_SOURCE_SIMULATED_LAGGED_CLOUDY,
};
